...
from research.mixins import EntityAnalysisMixin, ReportSynthesizerMixin, ResultFilterMixin
...
class SimpleDeepResearch(EntityAnalysisMixin, ReportSynthesizerMixin, ResultFilterMixin):
    """
