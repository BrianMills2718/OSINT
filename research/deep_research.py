...
from research.mixins import EntityAnalysisMixin, HypothesisMixin, ReportSynthesizerMixin, ResultFilterMixin
...
class SimpleDeepResearch(EntityAnalysisMixin, HypothesisMixin, ReportSynthesizerMixin, ResultFilterMixin):
    """
