#!/usr/bin/env python3
"""
Basic Timing Test - Simple prompts to establish baseline performance
Tests basic GPT-5-mini response times for simple tasks
"""
...
def run_basic_timing_tests() -> List[Dict[str, Any]]:
    ...
    print("=" * 80)
    print("🚀 BASIC TIMING TESTS - GPT-5-MINI")
    print("=" * 80)
    print(f"Model: {MODEL}")
...
def main():
    ...
    print("Starting basic timing tests...")
    ...
    filename = f"basic_timing_results_{timestamp}.json"
    save_results(results, analysis, filename)
    
    print("\n✅ Basic timing tests completed!")
