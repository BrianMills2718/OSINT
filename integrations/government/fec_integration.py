...
class FECIntegration(DatabaseIntegration):
    ...
    def metadata(self) -> DatabaseMetadata:
        ...
        return DatabaseMetadata(
            ...
            # Rate Limit Recovery - FEC has 1,000 requests/hour (rolling)
    ...
    async def is_relevant(self, research_question: str) -> bool:
        ...
        try:
            ...
            logger.error(f"FEC relevance check FAILED: {e}", exc_info=True)
    ...
    async def execute_search(self,
        ...
        try:
            ...
            logger.error(f"FEC search failed: {e}", exc_info=True)
