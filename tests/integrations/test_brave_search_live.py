...
async def main():
    ...
    result = await integration.execute_search(search_params, api_key=os.getenv('BRAVE_SEARCH_API_KEY'), limit=5)
    ...
    result = await integration.execute_search(recent_params, api_key=os.getenv('BRAVE_SEARCH_API_KEY'), limit=3)
