#!/usr/bin/env python3
"""
Extract url, title, content, and year from Klippenstein articles JSON files.
...
def main():
    # Define paths
    input_dir = Path("/home/brian/sam_gov/klippenstein_articles")
    output_dir = Path("/home/brian/sam_gov/klippenstein_articles_extracted")
