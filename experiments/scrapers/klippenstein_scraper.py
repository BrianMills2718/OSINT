#!/usr/bin/env python3
"""
Scraper for Ken Klippenstein's articles from his sitemap.
"""
...
class KlippensteinScraper:
    def __init__(self, base_url="https://www.kenklippenstein.com"):
    ...
    def run(self, output_dir='klippenstein_articles'):
        ...
        print(f"\n✓ Scraping complete! Articles saved to {output_path}/")
        return all_articles


if __name__ == '__main__':
    scraper = KlippensteinScraper()
    scraper.run()
